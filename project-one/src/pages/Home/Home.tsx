...
const Home = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col mb-10 px-20">
            <h1 className="text-4xl font-bold text-left text-foreground">Objective of assignment:</h1>
            <p className="text-xl text-justify text-foreground">Build a React-based web application with a theme switcher. The switcher should allow users to select from three distinct themes (Theme 1, Theme 2, Theme 3) using a dropdown in the header. Each theme should not only change colors, but also alter structure, fonts, spacing, and layout.</p>
            <div className="flex flex-col mb-10 px-20 py-10 bg-white text-gray-900">
                  <h1 className="text-4xl font-bold text-left mb-8">Requirements:</h1>
                  <ol className="list-decimal list-inside space-y-6">
                    ...
                    <li className="text-xl font-bold mb-2">
                      ...
                      <p className="text-xl text-justify mt-2 mb-4">
                        Implement <span className="font-bold">three complete themes</span> with noticeable differences:
                      </p>
                      <ul className="list-disc list-inside ml-6 space-y-1">
                        <li className="text-base">
                          <span className="font-bold">Theme 1 (Default):</span> Minimalist layout with light background, simple
                          sans-serif font
                        </li>
                        <li className="text-base">
                          <span className="font-bold">Theme 2:</span> Dark mode with sidebar layout, bold serif font
                        </li>
                        <li className="text-base">
                          <span className="font-bold">Theme 3:</span> Colorful theme with card-based grid layout, playful Google
                          Font (e.g., "Pacifico")
                        </li>
                      </ul>
                      <p className="text-xl text-justify mt-4">
                        Layout, font size, margins, components&apos; structure and overall look should be clearly different across
                        themes.
                      </p>
                    </li>
                    ...
                    <li className="text-xl font-bold mb-2">
                      ...
                      <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                        ...
                        <li className="text-base">
                          <span className="ml-2">Use React Router and demonstrate the theme across multiple pages (Home, About, Contact)</span>
                        </li>
                        <li className="text-base">
